...
class TestGeneratePyramid:
    ...
    def test_pyramid_with_default_character(self):
        ...
        expected = "  *  \n *** \n*****\n"
        print("Test: Default character, 3 levels\n" + result)
    ...
    def test_pyramid_with_custom_character(self):
        ...
        result = generate_pyramid(3, '#')
        expected = "  #  \n ### \n#####\n"
        print("Test: Custom character '#', 3 levels\n" + result)
        assert result == expected
    ...
    def test_pyramid_single_level(self):
        ...
        expected = "*\n"
        print("Test: Single level, default char\n" + result)
        assert result == expected
    ...
    def test_pyramid_single_level_custom_char(self):
        ...
        result = generate_pyramid(1, '+')
        expected = "+\n"
        print("Test: Single level, custom char '+'\n" + result)
        assert result == expected
    ...
    def test_pyramid_max_levels(self):
        ...
        print("Test: Max levels (20), default char\n" + result)
    ...
    def test_pyramid_different_characters(self):
        ...
        for char in characters:
            ...
            print(f"Test: Custom char '{char}', 3 levels\n" + result)
    ...
    def test_newline_between_levels(self):
        ...
        result = generate_pyramid(3)
        lines = result.split('\n')
        print("Test: Newline between levels\n" + str(lines))
    ...
    def test_n_not_integer_string(self):
        """Test that ValueError is raised when n is a string, char is valid."""
        print("Test: n is string, char is valid")
        with pytest.raises(ValueError, match="n must be an integer between 1 and 20"):
            generate_pyramid('a', '#')

    def test_n_none(self):
        """Test that ValueError is raised when n is None, char is valid."""
        print("Test: n is None, char is valid")
        with pytest.raises(ValueError, match="n must be an integer between 1 and 20"):
            generate_pyramid(None, '#')

    def test_n_list(self):
        """Test that ValueError is raised when n is a list, char is valid."""
        print("Test: n is list, char is valid")
        with pytest.raises(ValueError, match="n must be an integer between 1 and 20"):
            generate_pyramid([3], '#')
